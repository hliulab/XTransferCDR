...
class SC_TrainDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        pert_id_left = temp_train_left["cov_drug"]
        # cell_id_right = temp_train_right["cell_type"]
        pert_id_right = temp_train_right["cov_drug"]

        # pert_id_cross_left = temp_cross_train_left["cov_drug"]
        # pert_id_cross_right = temp_cross_train_right["cov_drug"]

        cov_drug_left = temp_train_left["cov_drug"]
        cov_drug_right = temp_train_right["cov_drug"]

        # cov_drug_cross_left = temp_cross_train_left["cov_drug"]
        # cov_drug_cross_right = temp_cross_train_right["cov_drug"]

        temp_train_left = temp_train_left.drop(["cell_type", "SMILES", "cov_drug"])
        temp_train_right = temp_train_right.drop(["cell_type", "SMILES", "cov_drug"])

        # temp_cross_train_left = temp_cross_train_left.drop(["cell_type", "SMILES", "cov_drug"])
        # temp_cross_train_right = temp_cross_train_right.drop(["cell_type", "SMILES", "cov_drug"])
...
class SC_TestDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        cov_drug_a_1 = temp_treats_cell_a_with_pert_1["cov_drug"]
        cov_drug_b_1 = temp_treats_cell_b_with_pert_1["cov_drug"]
        temp_treats_cell_a_with_pert_1 = temp_treats_cell_a_with_pert_1.drop(
            ["cell_type", "SMILES", "cov_drug"]
        )
